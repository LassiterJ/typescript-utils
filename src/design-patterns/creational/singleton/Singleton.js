...
class Singleton {
  ...
  // Enhancement: Allow being called with just an object of options that may include a class reference and args.
  constructor(arg1, arg2, arg3) { //classRef = null, classArgs = [], options = {} || {classRef, classArgs, options}
    ...
    */
    const {classRef, classArgs, options: initialOptions = {}} = Singleton.processArgs({arg1, arg2, arg3, thisVal: this});
...
/* Get instance and return it  */
  ...
  static processArgs = ({arg1, arg2, arg3, thisVal}) => {
    ...
    return {
      ...
      options: isFirstArgSingletonOptions ? arg1 : arg3,
    }
  };
